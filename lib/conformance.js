...
const NODE_CLIENT_ROUTE_COVERAGE = [
    ...
    { path: '/_diagnostics/storage', methods: ['GET'], status: 'omitted', reason: 'Internal benchmark diagnostics endpoint; not part of the public SDK contract.' },
    { path: '/_admin/storage/durability-barrier', methods: ['POST'], status: 'omitted', reason: 'Internal benchmark durability primitive; not part of the public SDK contract.' },
